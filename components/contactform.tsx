            ...
            <div className="col-span-2 md:col-span-1">
              <Input
                ...
                classNames={{
                  ...
                  input: "text-[#373A36]",
                  inputWrapper:
                    "bg-[#FFFFFF] border-[#373A36]/30 hover:border-[#9B0D15] focus-within:border-[#9B0D15]",
                }}
              />
              <ErrorMessage
                className="text-sm text-[#9B0D15]"
                component="div"
                name="first_name"
              />
            </div>
            ...
            <div className="col-span-2 md:col-span-1">
              <Select
                ...
                classNames={{
                  ...
                  value: "text-[#373A36]",
                  trigger:
                    "bg-[#FFFFFF] border-[#373A36]/30 hover:border-[#9B0D15] data-[focus=true]:border-[#9B0D15]",
                }}
              >
                {data
              ...
              <ErrorMessage
                className="text-tiny text-[#9B0D15]"
                component="div"
                name="property_name"
              />
            </div>
