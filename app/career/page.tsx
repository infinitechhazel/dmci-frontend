    ...
    <section className="container mx-auto flex-grow max-w-7xl px-2 py-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
        <div className="col-span-2 px-2">
          <h1 className="text-2xl font-bold text-red-600 uppercase md:text-4xl">Apply Now!</h1>
          ...
          <div className="py-8">
            ...
            <div className="flex flex-col gap-2 py-2">
              <div className="flex items-center gap-2">
                <div className="bg-red-200 py-2 px-2 rounded-lg">
                  <LuMail className="text-red-800" size={18} />
                </div>
                :
              ...
              <div className="flex items-center gap-2">
                <div className="bg-red-200 py-2 px-2 rounded-lg">
                  <FaMobileScreenButton  className="text-red-800" size={18} />
                </div>
                :
            ...
            <div className="py-4">
              ...
              <div className="flex gap-2 py-2">
                <Link href={'https://www.facebook.com/share/We79XYCKWCDWmhE2/?mibextid=JRoKGi'} target="_blank">
                  <div className="bg-red-200 py-2 px-2 rounded-lg">
                    <FaFacebook className="text-red-700" size={20} />
                  </div>
                </Link>

                <Link href={'https://www.instagram.com/ella.dmcihomes?igsh=MXdkOGhlcXJ6ZXJoaw%3D%3D&utm_source=qr'} target="_blank">
                  <div className="bg-red-200 py-2 px-2 rounded-lg">
                    <FaSquareInstagram className="text-red-700" size={20} />
                  </div>
                </Link>
                <Link href={'https://t.me/+639175480999'} target="_blank">
                  <div className="bg-red-200 py-2 px-2 rounded-lg">
                    <FaTelegram className="text-red-700" size={20} />
                  </div>
                </Link>
                <Link href={'viber://chat?number=639175480999'}>
                  <div className="bg-red-200 py-2 px-2 rounded-lg">
                    <FaViber className="text-red-700" size={20} />
                  </div>
                </Link>
                <Link href="https://wa.me/639175480999" rel="noopener noreferrer">
                  <div className="bg-red-200 p-2 rounded-lg flex items-center justify-center">
                    <FaWhatsapp className="text-red-700" size={20} />
                  </div>
                </Link>
                <Link href="weixin://dl/chat?number=639175480999" rel="noopener noreferrer">
                <div className="bg-red-200 p-2 rounded-lg flex items-center justify-center">
                  <FaWeixin className="text-red-700" size={20} />
                </div>
              </Link>
        ...
        <div className="col-span-3 md:col-span-1 w-full">
          <Card className="w-full">
            ...
            <div className="flex items-center gap-3 mb-4">
                <div className="bg-red-200 py-2 px-2 rounded-full">
                    <LuFileUser className="text-red-700" size={32} />
                </div>

                <div>
                    <h1 className="uppercase font-bold text-lg text-red-700">Application Form</h1>
