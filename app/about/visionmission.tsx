    ...
    <section className="flex flex-col gap-4 px-4 py-4 sm:px-6 md:py-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-2 w-full mt-8 gap-8">
        <div className="text-start">
          <h1 className="font-bold text-2xl sm:text-3xl">Vision & Mission</h1>
          ...
          <ul className="space-y-1 text-sm sm:text-base text-gray-500 list-disc list-inside dark:text-gray-400">
        ...
        <div className="text-start">
          <h1 className="font-bold text-2xl sm:text-3xl">The DMCI Creed</h1>
          <h2 className="mb-2 text-lg font-semibold mt-4 text-gray-900 dark:text-white">
            We believe:
          </h2>
          <ul className="space-y-4 text-sm sm:text-base text-gray-500 dark:text-gray-400">
            <li>
